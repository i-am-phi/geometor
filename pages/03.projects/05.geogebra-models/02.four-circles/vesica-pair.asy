...
pair A = (-0.5,0.), B = (0.5,0.), p01 = (0.,0.8660254037844386), p02 = (0.,-0.8660254037844387), p03 = (0.,0.); 
 /* draw figures */
draw((xmin, 0.*xmin0.)--(xmax, 0.*xmax0.), linewidth(2.) + white); /* line */
draw(circle(A, 1.), linewidth(2.) + dotted + white); 
draw(circle(B, 1.), linewidth(2.) + dotted + white); 
